...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
    let obg = {nombre: nombre, edad: edad, meow: function(){return "Meow!"}}
    return obg
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   let obj = {nombre: nombre, email: email, password: password}
   return obj
}
...
function tieneEmail(objetoUsuario) {
   ...
   if(obj.email.length > 1 && obj.email.includes("@") && objetoUsuario.hasOwnProperty("email")) return true
   else return false
